...
ActiveRecord::Schema.define(version: 20170518145949) do
  ...
  create_table "follows", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["access_point_id"], name: "index_follows_on_access_point_id"
    t.index ["user_id", "access_point_id"], name: "index_follows_on_user_id_and_access_point_id", unique: true
