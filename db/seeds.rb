...
ap1 = AccessPoint.create(ssid: '1号館')
ap2 = AccessPoint.create(ssid: '2号館')
ap3 = AccessPoint.create(ssid: '3号館')
ap4 = AccessPoint.create(ssid: '4号館')
ap5 = AccessPoint.create(ssid: '5号館')
cpsf11 = AccessPoint.create(ssid: '岩井研 11F')
cpsf14 = AccessPoint.create(ssid: '岩井研 14F')
